...
export const ComandosTrainingPanel: React.FC = () => {
  ...
  return <section style={{ marginTop: 18, background: '#101820', border: '1px solid #2b4858', borderRadius: 8, padding: 14 }} aria-label="Curso de Comandos Elétricos">
    <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap', color: '#dff8ff' }}><strong>🎓 Treinamento de Comandos Elétricos · 80 horas</strong><span>{COMANDOS_TRAINING_TOTAL_MINUTES / 60} h · liberação sequencial</span></div>
